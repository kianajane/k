	...
	*/
	...
	return Meteor.methods({
		...
		addFakeData: function() {
			...
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "lamp", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "lips", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "dollar", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "elbow", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "shoelace", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "violin", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "toilet", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "owl", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "please", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
			History.insert({userId: Meteor.userId(), mode: "game" , sound: "L" , word: "cloud", correct: true, time: new Date(s.getFullYear(), s.getMonth(),s.getDate() - 21) }),
