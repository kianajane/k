Meteor.startup(function(){
	...
	if (Phonetics.find({}).count()==0) {
		...
		Phonetics.insert({
			...
			story: new Array ("Kissing is gross. It makes me sick.",
							  "On Valentine's Day my dad gave my mom some sunflowers in a glass vase.",
							  "But that wasn't all.",
							  "He also bought her a new purse, a bracelet, and a red dress.",
							  "Mom was so surprised!",
							  "She was so excited about all of her gifts that she threw her arms around dad and gave him a big kiss.",
							  "Yuck! It's one thing for them to say that they love each other all the time, but the kissing is too much for me.",
							  "I have decided to start a club called \"Anything But Lips\" for people like me who don't like kissing.",
							  "I posted a sign outside and told all of my friends to come.",
							  "We are going to meet in my dad's office once a week at six o'clock.",
