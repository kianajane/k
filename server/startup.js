Meteor.startup(function(){
	...
	if (Phonetics.find({}).count()==0) {
		...
		Phonetics.insert({sound: "B", words: new Array ("baby", "bakery", "banana", "becoming", "bedtime", "bedroom", "buddy", "about", "alphabet", "blueberry", "cowboy boots", "ladybug", "October", "rabbit", "bathtub", "ice cube"), 
		...
		Phonetics.insert({sound: "H", words: new Array ("hall","hand", "happy", "beehive", "playhouse", "horse", "White House", "hair", "helicopter", "history", "hero", "honeybee", "helmet", "hippopotamus"), 
		...
		Phonetics.insert({sound: "M", words: new Array ("man", "map", "March", "human", "tomato", "game", "dream", "maybe", "machine", "mammal", "marshmellow", "magnificent", "macaroni", "memorization"), 
