	...
	if (Phonetics.find({}).count()==0) {
		Phonetics.insert({
			...
			words: new Array ("leaf", "lamp", "laugh", "leg", "lunch", "lips", "late", "lucky", "lion", "lock", "dollar", "olive",
							  "belly", "<ADD WORD>", "jelly", "elbow", "shoelace", "violin", "envelope", "toilet", "bell", "whale",
							  "owl", "wall", "glass", "sleep", "slide", "please", "flower", "cloud"), 
		...
		Phonetics.insert({
			sound: "M",
			words: new Array ("man", "map", "march", "mall", "meet", "miss", "milk", "mine", "moose", "timer", "image", "human",
							  "dream", "palm", "pulm", "tomato", "maybe", "machine", "mammal", "marshmallow", "magnificent",
							  "macaroni", "memorization"), 
			story: new Array ("Mindy wanted to travel more.",
							  ...
							  "She wanted to climb the highest mountain, swim in the ocean, and see the bathroom in a king's palace.",
							  "She would have so many stories to tell.",
